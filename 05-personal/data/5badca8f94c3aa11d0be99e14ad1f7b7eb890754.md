...
- Name: test\05_registrar_empleado.spec.ts >> Registrar Empleado >> Legajo negativo debe mostrar error
- Location: e2e\test\05_registrar_empleado.spec.ts:229:9
...
Locator: getByText('El legajo debe ser un número entero positivo')
Expected: visible
Timeout: 3000ms
...
Call log:
  ...
  - waiting for getByText('El legajo debe ser un número entero positivo')
  ...
  - generic [ref=e6]:
    ...
    - generic [ref=e58]:
      - generic [ref=e60]:
        ...
        - table [ref=e134]:
          ...
          - rowgroup [ref=e143]:
            - 'row "JG Juan Garcia juan.garcia@workshift.com Legajo: 300006 INSPECTOR B 14:00-23:00 ACTIVO" [ref=e144]':
              ...
              - cell [ref=e160]:
                - generic [ref=e161]:
                  - button "Ver detalles" [ref=e162] [cursor=pointer]:
                    - img [ref=e163]
        ...
        - generic [ref=e435]:
          - generic [ref=e437]:
            - heading "Nuevo Empleado" [level=2] [ref=e438]
            - button "Cerrar modal" [ref=e439] [cursor=pointer]:
              - img [ref=e440]
          - generic [ref=e444]:
            - generic [ref=e445]:
              - generic [ref=e446]:
                - generic [ref=e447]: Nombre *
                - 'textbox "Ej: Juan" [ref=e448]': Ana
              - generic [ref=e449]:
                - generic [ref=e450]: Apellido *
                - 'textbox "Ej: Pérez" [ref=e451]': García
            - generic [ref=e452]:
              - generic [ref=e453]:
                - generic [ref=e454]: Legajo *
                - spinbutton [ref=e455]: "-5"
              - generic [ref=e456]:
                - generic [ref=e457]: Email *
                - 'textbox "Ej: juan.perez@email.com" [ref=e458]': bug01.23715@wsms.com
            - generic [ref=e459]:
              - generic [ref=e460]:
                - generic [ref=e461]: Rol
                - combobox [ref=e462]:
                  - option "Inspector" [selected]
                  - option "Supervisor"
                  - option "Jefe"
              - generic [ref=e463]:
                - generic [ref=e464]: Grupo de Turno
                - combobox [ref=e465]:
                  - option "Turno A" [selected]
                  - option "Turno B"
            - generic [ref=e466]:
              - generic [ref=e467]: Horario Laboral
              - combobox [ref=e468]:
                - option "04:00-14:00" [selected]
                - option "06:00-16:00"
                - option "10:00-20:00"
                - option "13:00-23:00"
                - option "19:00-05:00"
            - generic [ref=e469]:
              - generic [ref=e470]:
                - generic [ref=e471]: Teléfono
                - 'textbox "Ej: +54 221 123-4567" [ref=e472]'
              - generic [ref=e473]:
                - generic [ref=e474]: Fecha de Nacimiento
                - textbox [ref=e475]
            - generic [ref=e476]:
              - generic [ref=e477]: Dirección
              - 'textbox "Ej: Calle 123, Cipolletti" [ref=e478]'
            - generic [ref=e479]:
              - checkbox "Cuenta activa" [checked] [ref=e480]
              - generic [ref=e481] [cursor=pointer]: Cuenta activa
          - generic [ref=e482]:
            - button "Cancelar" [ref=e483] [cursor=pointer]
            - button "Crear Empleado" [active] [ref=e484] [cursor=pointer]:
              - img [ref=e485]
              - text: Crear Empleado
      - contentinfo [ref=e488]:
        - generic [ref=e489]: © 2026 Gestión de Turnos. Todos los derechos reservados.
        - generic [ref=e490]:
          - link "Política de Privacidad" [ref=e491] [cursor=pointer]:
            - /url: /dashboard/privacy
          - generic [ref=e492]: "|"
          - link "Términos y Condiciones" [ref=e493] [cursor=pointer]:
            - /url: /dashboard/terms
        - generic [ref=e494]:
          - generic [ref=e495]: Powered by
          - img "WSMS Logo" [ref=e497]
    - button [ref=e498] [cursor=pointer]:
      - img [ref=e499]
    - button "Abrir asistente" [ref=e501] [cursor=pointer]:
      - img [ref=e502]
...
```ts
  149 | 
  150 |     // ── Validaciones de email ─────────────────────────────────────
  151 | 
  152 |     test('Email con formato inválido muestra error', async ({ page }) => {
  153 |         await test.step('Abrir el formulario e ingresar email sin arroba', async () => {
  154 |             await abrirFormularioCrear(page);
  155 |             await completarObligatorios(page, { legajo: uid(), email: 'emailsinArroba.com' });
  156 |         });
  157 | 
  158 |         await test.step('Enviar el formulario', async () => {
  159 |             await page.locator('button:has-text("Crear Empleado")').click();
  160 |             await scrollModalAlTop(page);
  161 |         });
  162 | 
  163 |         await test.step('Verificar mensaje de error de formato de email', async () => {
  164 |             await expect(page.getByText('El formato del email no es válido')).toBeVisible({ timeout: 3000 });
  165 |         });
  166 |     });
  167 | 
  168 |     test('Email duplicado muestra error', async ({ page }) => {
  169 |         const id = uid();
  170 |         const email = `emailunico.${id}@wsms.com`;
  171 | 
  172 |         await test.step('Registrar un empleado con el email de referencia (condición previa)', async () => {
  173 |             await crearEmpleado(page, id, email);
  174 |         });
  175 | 
  176 |         await test.step('Abrir nuevo formulario e ingresar el mismo email', async () => {
  177 |             await abrirFormularioCrear(page);
  178 |             await completarObligatorios(page, { legajo: `${id}1`, email });
  179 |         });
  180 | 
  181 |         await test.step('Enviar el formulario', async () => {
  182 |             await page.locator('button:has-text("Crear Empleado")').click();
  183 |             await scrollModalAlTop(page);
  184 |         });
  185 | 
  186 |         await test.step('Verificar mensaje de error de email duplicado', async () => {
  187 |             await expect(page.getByText('El email ya está registrado en otro empleado')).toBeVisible({ timeout: 3000 });
  188 |         });
  189 |     });
  190 | 
  191 |     // ── Validaciones de fecha de nacimiento ──────────────────────
  192 | 
  193 |     test('Fecha de nacimiento futura muestra error', async ({ page }) => {
  194 |         await test.step('Abrir el formulario e ingresar fecha futura (01/01/2030)', async () => {
  195 |             await abrirFormularioCrear(page);
  196 |             await completarObligatorios(page, { legajo: uid() });
  197 |             await page.locator('form').locator('input[type="date"]').first().fill('2030-01-01');
  198 |         });
  199 | 
  200 |         await test.step('Enviar el formulario', async () => {
  201 |             await page.locator('button:has-text("Crear Empleado")').click();
  202 |             await scrollModalAlTop(page);
  203 |         });
  204 | 
